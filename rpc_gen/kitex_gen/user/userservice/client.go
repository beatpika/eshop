...
func (p *kUserServiceClient) UpdatePhone(ctx context.Context, Req *user.UpdatePhoneReq, callOptions ...callopt.Option) (r *user.UpdatePhoneResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdatePhone(ctx, Req)
}

func (p *kUserServiceClient) DeactivateAccount(ctx context.Context, Req *user.DeactivateAccountReq, callOptions ...callopt.Option) (r *user.DeactivateAccountResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeactivateAccount(ctx, Req)
}
