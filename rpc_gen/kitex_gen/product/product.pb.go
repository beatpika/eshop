...
type Product struct {
	...
	Categories  []string `protobuf:"bytes,7,rep,name=categories,proto3" json:"categories,omitempty"` // 商品分类
}
...
type ListProductsReq struct {
	...
	Category string `protobuf:"bytes,3,opt,name=category,proto3" json:"category,omitempty"` // 商品分类
}
...
func (x *SearchProductsReq) GetKeywords() string {
	if x != nil {
		return x.Keywords
	}
	return ""
...
var file_product_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x22, 0x1f, 0x0a, 0x0d, 0x47,
	...
	0x74, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x5d, 0x0a, 0x0f, 0x4c, 0x69,
	...
	0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x56, 0x0a, 0x10, 0x4c, 0x69, 0x73,
	...
	0x6c, 0x22, 0x5f, 0x0a, 0x11, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72,
	...
	0x7a, 0x65, 0x22, 0x56, 0x0a, 0x12, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x72, 0x6f, 0x64,
	...
	0x01, 0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xca, 0x03, 0x0a, 0x15, 0x50,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x65, 0x61, 0x74, 0x70, 0x69, 0x6b, 0x61, 0x2f, 0x65,
	0x73, 0x68, 0x6f, 0x70, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x6b, 0x69, 0x74,
...
var file_product_proto_depIdxs = []int32{
	...
	0,  // 1: product.UpdateProductResp.product:type_name -> product.Product
	0,  // 2: product.GetProductResp.product:type_name -> product.Product
	0,  // 3: product.ListProductsResp.products:type_name -> product.Product
	0,  // 4: product.SearchProductsResp.results:type_name -> product.Product
	1,  // 5: product.ProductCatalogService.CreateProduct:input_type -> product.CreateProductReq
	...
	9,  // 8: product.ProductCatalogService.ListProducts:input_type -> product.ListProductsReq
	7,  // 9: product.ProductCatalogService.GetProduct:input_type -> product.GetProductReq
	11, // 10: product.ProductCatalogService.SearchProducts:input_type -> product.SearchProductsReq
	2,  // 11: product.ProductCatalogService.CreateProduct:output_type -> product.CreateProductResp
	...
	10, // 14: product.ProductCatalogService.ListProducts:output_type -> product.ListProductsResp
	8,  // 15: product.ProductCatalogService.GetProduct:output_type -> product.GetProductResp
