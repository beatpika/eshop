...
func (c *clientImpl) UpdateOrderStatus(ctx context.Context, Req *order.UpdateOrderStatusReq, callOptions ...callopt.Option) (r *order.UpdateOrderStatusResp, err error) {
